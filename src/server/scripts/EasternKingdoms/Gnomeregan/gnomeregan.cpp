...
{
    {-557.630ff,-114.514f,-152.209f, 0.641},
    {-555.263f,-113.802f,-152.737f, 0.311},
    {-552.154f,-112.476f,-153.349f, 0.621},
    {-548.692f,-111.089f,-154.090f, 0.621},
    {-546.905f,-108.340f,-154.877, 0.729},
    {-547.736f,-105.154f,-155.176f, 0.372f},
    {-547.274f,-114.109f,-153.952f, 0.735f},
    {-552.534f,-110.012f,-153.577f, 0.747f},
    {-550.708f,-116.436f,-153.103f, 0.67f},
    {-554.030f,-115.983f,-152.635f, 0.69f},
    ...
    {-494.195f,-89.553f,-149.131f, 3.254}
};
        ...
        switch (uiCase)
        {
            ...
            case 2:
                if (GameObject* pGo = me->SummonGameObject(183410, -533.140,-105.322,-156.016, 0, 0, 0, 0, 0, 1000))
                {
                    ...
                    pGo->SetFlag(GAMEOBJECT_FLAGS, GO_FLAG_NO_INTERACT); //We can't use it!
                }
                Summon(3);
                break;
            case 3:
