...
enum ProcFlagsEx
{
    ...
    PROC_EX_INTERNAL_AURA_APPLY = 0x4000000                  // Only for internal use
};
...
#define SPELL_ATTR_CU_WELL_FED              0x00010000
#define SPELL_ATTR_CU_DONT_BREAK_ON_DAMAGE  0x00020000
