...
ChatCommand * ChatHandler::getCommandTable()
{
    ...
    static ChatCommand reloadCommandTable[] =
    {
        ...
        { "spell_ranks",                SEC_ADMINISTRATOR, true,  &ChatHandler::HandleReloadSpellRanksCommand,              "", NULL },
    ...
    {
        { "ip",            SEC_MODERATOR,      true,  &ChatHandler::HandleLookupPlayerIpCommand,       "", NULL },
        { "account",       SEC_MODERATOR,      true,  &ChatHandler::HandleLookupPlayerAccountCommand,  "", NULL },
        { "email",         SEC_MODERATOR,      true,  &ChatHandler::HandleLookupPlayerEmailCommand,    "", NULL },
        { NULL,             0,                  false, NULL,                                            "", NULL }
    };
    ...
    static ChatCommand tempEventCommandTable[] =
    {
        ...
        { "status",        SEC_GAMEMASTER,     false,  &ChatHandler::HandleTempEventSetStatusCommand,	    "", NULL },
        { "reset",         SEC_GAMEMASTER,     false,  &ChatHandler::HandleTempEventResetCommand,			"", NULL },
    ...
    static ChatCommand commandTable[] =
    {
        ...
        { "cancelflush",   SEC_ADMINISTRATOR, true,  &ChatHandler::HandleCancelFlushCommand,          "", NULL },
