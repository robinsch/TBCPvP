...
void World::LoadConfigSettings(bool reload)
{
    ...
    if (reload)
    {
        ...
        m_configs[CONFIG_PORT_WORLD] = ConfigMgr::GetIntDefault("WorldServerPort", 8085);
    ...
    m_configs[CONFIG_ALLOW_PLAYER_COMMANDS]              = ConfigMgr::GetBoolDefault("AllowPlayerCommands", true);
    ...
    m_configs[CONFIG_DIE_COMMAND_MODE] = ConfigMgr::GetBoolDefault("Die.Command.Mode", true);
    ...
    m_configs[CONFIG_ENABLE_FAKE_WHO_ON_ARENA]                  = ConfigMgr::GetBoolDefault("Arena.EnableFakeSocial", true);
